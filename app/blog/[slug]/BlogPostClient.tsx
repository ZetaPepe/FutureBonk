...
import { ArrowLeft, BrainCircuit, Clock, Share2, Twitter } from "lucide-react"
...
export default function BlogPostClient({ post, slug }: { post: any; slug: string }) {
  ...
  const handleShare = (platform: string) => {
    ...
    switch (platform) {
      case "twitter":
        shareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=${encodeURIComponent(text)}&via=futurebonk`
        break
      default:
        // Copy to clipboard
