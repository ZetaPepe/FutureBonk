      ...
      <div className="min-h-screen bg-black text-white">
        <header className="container mx-auto py-6">
          <div className="flex items-center justify-between">
            <Link href="/" className="text-xl font-bold tracking-tighter">
              Future<span className="text-purple-500">Bonk</span>
            </Link>
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <FadeIn>
              <h1 className="text-4xl font-bold mb-8">About FutureBonk</h1>
            </FadeIn>

            <div className="prose prose-invert prose-purple max-w-none">
              <FadeIn delay={0.2}>
                <p className="text-xl text-gray-300 mb-8">
                  FutureBonk is dedicated to exploring the frontiers of artificial intelligence, with a focus on recent
              ...
              <ScrollFade>
                <h2>What We Cover</h2>
                <p>At FutureBonk, we focus on several key areas in the AI landscape:</p>
              ...
              <ScrollFade>
                <h2>Our Team</h2>
                <p>
                  FutureBonk is run by a team of AI researchers, engineers, and enthusiasts who are passionate about the
        ...
        <footer className="border-t border-gray-800 py-12">
          <div className="container mx-auto px-4">
            ...
            <div className="border-t border-gray-800 mt-12 pt-6 text-sm text-gray-400">
              <p>© {new Date().getFullYear()} FutureBonk. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
