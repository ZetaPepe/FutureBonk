...
import { BrainCircuit, Clock, Cpu, Eye, Mail, Twitter } from "lucide-react"
                ...
                <FadeIn>
                  <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                    ...
                    <span className="text-purple-500">
                      <TypingText text="Artificial Intelligence" delay={500} />
                    </span>
                  </h1>
                </FadeIn>
                <FadeIn delay={0.3}>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-400">
                    Subscribe to our newsletter to receive the latest insights on AI advancements, tutorials, and
                    industry news.
                  </p>
                </div>
